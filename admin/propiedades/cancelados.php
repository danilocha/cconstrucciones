        ...
        <table>
          ...
          while ($f =$res->fetch_assoc()) {?>
            <tr>
              ...
              <td><a href="#" class="btn-floating red" onclick="swal({ title: 'Esta seguro que desea suspender la propiedad?', text:'Al eliminarla no podra recuperarla', type: 'warning', showCancelButton: true, confirmButtonColor: '#3085d6', cancelButtonColor: '#d33', confirmButtonText: 'Si, eliminarla!' }).then(function () {  location.href='eliminar_propiedad.php?id=<?php echo $f['propiedad'] ?>&foto=<?php echo $f['foto_principal'] ?>'; })"><i class="material-icons">delete_forever</i></a></td>
            </tr>
          <?php }
          $sel->close();
          $con->close();
