          ...
          <div class="row">
            <div class="col s6">
              <select id="estado" name="estado" required="">
                <?php 
                $sel_edo = $con->prepare("SELECT id_departamento FROM departamentos WHERE departamento =? ");
                ...
                <option value="<?php echo $f_edo['id_departamento'] ?>" > <?php echo $f_prop['estado'] ?> </option>
                <?php $sel_estado = $con->prepare("SELECT * FROM departamentos ");
                $sel_estado->execute();
            ...
            <div class="col s6">
              <div class="res_estado">
                <input type="text" name="municipio" value="<?php echo $f_prop['estado'] ?>" readonly>
              </div>
            </div>
          </div>
        <div class="row">
