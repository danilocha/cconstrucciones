...
?>
	...
	<div class="row">
		<div class="col s6">
		    <h2 class="header">Cambiar foto de Principal</h2>
			...
			<div class="card">
				<div class="card-content">
					...
					while ($f_img =$res_img->fetch_assoc()) {?>
						...
						<a href="#"  onclick="swal({ title: 'Estas seguro que desea eliminar la imagen', text: 'Al eliminarla no podra recuperarla!', type: 'warning', showCancelButton: true, confirmButtonColor: '#3085d6', cancelButtonColor: '#d33', confirmButtonText: 'Si, eliminarla!' }).then(function () {  location.href='eliminar_img.php?id=<?php echo $f_img['id'] ?>&ruta=<?php echo $f_img['ruta'] ?>&id_propiedad=<?php echo $id ?>'; })"><img src="<?php echo $f_img['ruta'] ?>" alt=""></a>
